    ...
    <nav class="nav__ navfont">
        ...
        <div class="nav__controls nav__controls--right">
            <div class="nav__search">
                <input class="nav__search--input text-center" placeholder="" type="text"/><a class="nav__search--icon " href="#"><i class="material-icons">search</i></a>
            </div>
            ...
            <div class="nav__avatar"><img src="img/pessoa2.jpg" class="nav__avatar--image" style="width:35px">
                    ...
                    <div class="nav__avatar--dropdown"><a href="/login"></a>
                        ...
                        ?>
                        <a href="perfil.php"><button class="nav__btn2"> <!--<i class="fa fa-user mr-2">--> Ver perfil</button></a>
