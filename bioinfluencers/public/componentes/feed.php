<div class="container">
    ...
    $query = "SELECT id_partilhas, data_hora, descricao, utilizadores_id_utilizadores_p, id_utilizadores, nickname, img_perfil, filename, partilhas_id_partilhas, utilizadores_id_utilizadores, seguidores
              FROM partilhas
              LEFT JOIN conteudos
              ...
              WHERE seguidores = ? OR utilizadores_id_utilizadores_p = id_utilizadores
              ORDER BY data_hora DESC";

    if (mysqli_stmt_prepare($stmt, $query)) {
        mysqli_stmt_bind_param($stmt, 'i', $id_u_feed);
        mysqli_stmt_execute($stmt);
        mysqli_stmt_bind_result($stmt, $id_partilhas, $data_hora, $descricao, $utilizadores_id_utilizadores_p, $id_utilizadores, $nome_u, $img_perfil, $filename, $partilhas_id_partilhas, $utilizadores_id_utilizadores, $id_u_feed);
