    ...
    <div class="container">
        ...
        <div class="alinhar">
            ...
            <div class="text-center ">
                <p class="text-center ">Lorem ipsum dolor sit amet, ea constituam voluptatibus est, vitae vidisse
                    recteque ea eam. Iudico oblique fabellas an vis, eos eirmod constituam ad, ex delicata oportere
                    signiferumque eum. </p>
            </div>
            ...
            <div class="col-12">
                <ul class="nav nav-tabs">
                    <li class="nav-item col-4">
                        <a class="nav-link active" data-toggle="tab" href="#galeria"><img class="img-fluid icon_perfil"
                                                                                          src="img/galeria.png"></a>
                    </li>
                    <li class="nav-item col-4">
                        <a class="nav-link" data-toggle="tab" href="#medalhas"><img class="img-fluid"
                                                                                    src="img/med_trof.png"></a>
                    </li>
                    <li class="nav-item col-4">
                        <a class="nav-link" data-toggle="tab" href="#evento"><img class="img-fluid"
