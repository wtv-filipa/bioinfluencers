...
if (isset($_GET["g"]) && isset($_SESSION['id_utilizadores']) && isset($_GET["c"])) {
    $id_partilhas = $_GET["g"];
    ...
    if (mysqli_stmt_prepare($stmt, $query)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo "olha gostou!";
            // SUCCESS ACTION
            header("Location: ../publicacao_ind.php?img=".$id_c."");
        } else {
            // ERROR ACTION
    ...
    if (isset($_GET["ng"]) && isset($_SESSION['id_utilizadores']) && isset($_GET["c"])) {
